...
export async function removeMember(classId: string, targetUserId: string) {
  const user = await requireUser();
...
export async function promoteModerator(classId: string, targetUserId: string) {
  const user = await requireUser();
  await requireClassFounder(user.id, classId);
...
export async function demoteModerator(classId: string, targetUserId: string) {
  const user = await requireUser();
  await requireClassFounder(user.id, classId);
...
export async function transferClassOwnership(classId: string, targetUserId: string) {
  const user = await requireUser();
  await requireClassFounder(user.id, classId);
